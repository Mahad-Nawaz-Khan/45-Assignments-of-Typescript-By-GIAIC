...
var places = ["Kashmir", "Tokyo", "Venice", "Lahore", "Islamabad"];
...
var placesAlphabetical = __spreadArray([], places, true).sort();
...
var placesReverseAlphabetical = __spreadArray([], places, true).sort().reverse();

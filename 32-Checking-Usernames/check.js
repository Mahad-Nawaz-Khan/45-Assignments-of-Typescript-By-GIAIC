...
var current_users = ["Asjad", "Mahad", "Ajwad", "admin", "Ali"];
var new_users = ["asjad", "Raheel", "AJWAD", "sikandar", "Jahangir"];
for (var i = 0; i < new_users.length; i++) {
    var new_user = new_users[i].toLowerCase();
    var current_user = current_users[i].toLowerCase();
